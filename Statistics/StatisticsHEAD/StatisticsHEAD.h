...
#ifndef StatisticsHEAD_
#define StatisticsHEAD_

#include "IKAROS.h"

class StatisticsHEAD: public Module
{
public:
//INPUTS
    ...
    static Module * Create(Parameter * p) {return new StatisticsHEAD(p);};

    StatisticsHEAD(Parameter * p) : Module(p) {};
    virtual ~StatisticsHEAD() {};
